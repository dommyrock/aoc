//First value we pop of the priority queue = length of the shortest path
//Dikstra gives us the len of th eshortest path to every node
//We chose Dfs instead
////we can maintain 10 queues because there are limited costs 1..=9
